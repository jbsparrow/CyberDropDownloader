...
IS_WINDOWS_OR_MACOS = sys.platform in ("darwin", "win32")


# @pytest.mark.skipif(not IS_WINDOWS_OR_MACOS, reason="pycares normally fails on any other platform")
def test_dns_resolver_should_be_async_on_windows_and_macos() -> None:
