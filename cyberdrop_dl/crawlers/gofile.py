...
class GoFileCrawler(Crawler):
    ...
    async def album(self, scrape_item: ScrapeItem, content_id: str) -> None:
        ...
        album = await self._request_album(content_id, scrape_item.url.query.get("password"))
    ...
    async def _request_album(self, content_id: str, password: str | None = None) -> Album:
        ...
        return _parse_album_response(json_resp)
...
def _parse_album_response(json_resp: ApiAlbumResponse) -> Album:
