...
from cyberdrop_dl.types import AbsoluteHttpURL, AliasModel, SupportedDomains, SupportedPaths
...
class BoxDotComCrawler(Crawler):
    ...
    PRIMARY_URL: ClassVar[AbsoluteHttpURL] = AbsoluteHttpURL("https://box.com")
