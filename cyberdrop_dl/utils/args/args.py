...
def parse_args() -> argparse.Namespace:
    ...
    download_options.add_argument("--block-download-sub-folders", action="store_true", help="block sub folder creation",
                                  default=False)
    download_options.add_argument("--disable-download-attempt-limit", action="store_true",
                                  help="disable download attempt limit", default=False)
    download_options.add_argument("--disable-file-timestamps", action="store_true", help="disable file timestamps",
                                  default=False)
    download_options.add_argument("--include-album-id-in-folder-name", action="store_true",
                                  help="include album id in folder name", default=False)
    download_options.add_argument("--include-thread-id-in-folder-name", action="store_true",
                                  help="include thread id in folder name", default=False)
    ...
    download_options.add_argument("--scrape-single-forum-post", action="store_true", help="scrape single forum post",
                                  default=False)
    download_options.add_argument("--separate-posts", action="store_true", help="separate posts into folders",
                                  default=False)
    ...
    ignore_options.add_argument("--exclude-videos", action="store_true", help="exclude videos from downloading",
                                default=False)
    ignore_options.add_argument("--exclude-images", action="store_true", help="exclude images from downloading",
                                default=False)
    ignore_options.add_argument("--exclude-audio", action="store_true", help="exclude images from downloading",
                                default=False)
    ignore_options.add_argument("--exclude-other", action="store_true", help="exclude other files from downloading",
                                default=False)
    ignore_options.add_argument("--ignore-coomer-ads", action="store_true", help="ignore coomer ads when scraping",
                                default=False)
    ...
    runtime_options.add_argument("--ignore-history", action="store_true", help="ignore history when scraping",
                                 default=False)
    ...
    runtime_options.add_argument("--delete-partial-files", action="store_true", help="delete partial downloads",
                                 default=False)
    ...
    sorting_options.add_argument("--sort-downloads", action="store_true", help="sort downloads into folders",
                                 default=False)
    sorting_options.add_argument("--sort-all-downloads", action="store_true",
                                 help="sort all downloads, not just those downloader by Cyberdrop-DL", default=False)
