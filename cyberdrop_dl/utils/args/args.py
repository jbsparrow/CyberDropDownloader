...
def parse_args() -> argparse.Namespace:
    ...
    general.add_argument(
        "--no-ui",
        action="store_true",
        help="Disables the UI/Progress view entirely",
        default=False,
    )
    general.add_argument(
        "--download",
    ...
    general.add_argument(
        "--sort-all-configs",
        action="store_true",
        help="Sort all configs sequentially",
        default=False,
    )
    general.add_argument(
        "--retry-failed",
    ...
    file_paths.add_argument(
        "--config-file",
        type=str,
        help="path to the CDL settings.yaml file to load",
        default="",
    )
    file_paths.add_argument(
        "--appdata-folder",
    ...
    file_paths.add_argument(
        "--main-log-filename",
        type=str,
        help="filename for the main log file",
        default="",
    )
    file_paths.add_argument(
    ...
    file_paths.add_argument(
        "--webhook_url",
        help="Discord webhook url to send download recap to",
        default="",
    )
    ...
    ui_options.add_argument(
        "--vi-mode",
        action="store_true",
        help="enable VIM keybindings for UI",
        default=None,
    )
    ui_options.add_argument(
        "--refresh-rate",
