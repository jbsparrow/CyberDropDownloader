...
def parse_args() -> argparse.Namespace:
    ...
    sorting_options.add_argument("--sort-folder", type=str, help="path to where you want CDL to store it's log files", default="")
    sorting_options.add_argument("--scan-folder", type=str, help="path to scan for files, if not set then the download_dir is used", default="")
