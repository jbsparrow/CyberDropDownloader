...
class OAuth:
    ...
    def get_devide_code(self, client_id: str, new_credentials: bool = False) -> dict:
        ...
        JSONResp = self.api.get('device/code', entrypoint=self.api.API_OAUTH_ENTRYPOINT, client_id=client_id,
    ...
    def get_credentials(self, client_id: str, device_code: str):
        ...
        return self.api.get('device/credentials', entrypoint=self.api.API_OAUTH_ENTRYPOINT, client_id=client_id,
                            code=device_code)
