...
class ConfigManager:
    ...
    def startup(self) -> None:
        ...
        self.authentication_settings = (
            self.manager.path_manager.config_dir / "authentication.yaml"
        )
        self.global_settings = (
            self.manager.path_manager.config_dir / "global_settings.yaml"
        )
        self.settings = (
            self.manager.path_manager.config_dir / self.loaded_config / "settings.yaml"
        )
