    ...
    async def forum_login(self, login_url: URL, session_cookie: str, username: str, password: str,
        ...
        while True:
            try:
                ...
                await self.manager.cache_manager.set_return_value(str(login_url), False, pop=False)
                await self.manager.cache_manager.set_return_value(str(login_url / "login"), False, pop=False)
