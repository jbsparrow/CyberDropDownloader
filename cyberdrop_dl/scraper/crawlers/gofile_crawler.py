...
ALBUM_DEFAULT_REGEX = re.compile(r"[a-zA-Z0-9]{6,7}")
...
class GoFileCrawler(Crawler):
    ...
    async def album(self, scrape_item: ScrapeItem) -> None:
        ...
        title = self.create_title(json_data["name"], content_id)
        if json_data["childrenCount"] == 1 and (json_data.get("isRoot", False) or ALBUM_DEFAULT_REGEX.match(title)):
