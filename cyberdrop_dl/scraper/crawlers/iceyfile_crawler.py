...
class IceyfileCrawler(Crawler):
    primary_base_domain = URL("https://iceyfile.com/")

    def __init__(self, manager: Manager) -> None:
        super().__init__(manager, "iceyfile", "Iceyfile")
        self.api_load_files = URL("https://iceyfile.com/account/ajax/load_files")
        self.api_details = URL("https://iceyfile.com/account/ajax/file_details")
        self.api_password_process = URL("https://iceyfile.com/ajax/folder_password_process")
