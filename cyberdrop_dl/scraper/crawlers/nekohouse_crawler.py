...
class NekohouseCrawler(Crawler):
            ...
            async with self.request_limiter:
                ...
                for post in posts:
                    ...
                    new_scrape_item = await self.create_scrape_item(
                        scrape_item, post_link, "", add_parent=self.primary_base_domain / service / "user" / user
                    )
    ...
    async def get_post_content(
        self, scrape_item: ScrapeItem, post: int, user: str, service: str, user_str: str, unlinked_post: bool = False
    ) -> None:
