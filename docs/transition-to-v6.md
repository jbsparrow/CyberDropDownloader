...
{% hint style="warning" %}
V4 import is no longer supported. Last version with v4 support was `6.4.0`. To upgrade to the latest version, you need to perform a sequential upgrade. First, update CDL to `6.4.0`, import your v4 files and then update to the latest version.
